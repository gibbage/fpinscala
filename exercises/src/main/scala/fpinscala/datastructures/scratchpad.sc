...
val sum0 = List.sum(List(1,2,3))
val sum1 = List.sum2(List(1,2,3))
val stringSum0 = List.sum3(List(1,2,3)) // See what we can do with different type :)
val product0 = List.product(List(1,2,3))
val product1 = List.product2(List(1,2,3))